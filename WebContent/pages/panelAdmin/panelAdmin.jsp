                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="home">
                                    ...
                                    <div class="row">
		                                <div class="col-md-6"><code id="ultimaact"></code></div>
		                                <div class="col-md-6">
		                                	<button onclick="actualizar()" class="btn btn-primary" type="button" id="btnActualizar">Actualizar</button>
		                                </div>
		                            </div>
                                </div>
                                    	...
                                    	<div class="col-lg-12">
                                    		<form role="form">
                                    			<div class="form-group">
                                    				...
                                    				<br />
                                    				<label>Seleccione los almacenes a asignar</label>
                                    ...
                                    <div class="row" id="uploadFileContainer">
                                    	<div class="col-lg-5">
											<form  id="formUploadFile" name="formUploadFile">
												...
												<img id="loadingGif" src="/Embarques/img/loading.gif">
                                    		</form>
                                    	</div><br><br>
                                    	<div class="col-lg-7">
